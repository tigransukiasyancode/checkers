...
class Move{
	public:
	struct CapturingPosition{
		CapturingPosition(int pos , int t):position(pos),to(t){}
		CapturingPosition(){}
		int position;
		int to;
	};
	typedef list<CapturingPosition>::const_iterator capturing_iterator;
	Move(){}
	...
	private:
	list<CapturingPosition> _capturing_positions;
	int _from;
	int _to;
};
/*class JumpMove{
